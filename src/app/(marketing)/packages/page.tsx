        ...
        <div className="container-page">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <SectionHeading
              ...
              level="h1"
              title="Preventive health checkups for practical screening."
              description="Choose from routine, diabetes, thyroid, senior citizen and women's wellness checkups. Contact the lab for current pricing and preparation guidance."
            />
